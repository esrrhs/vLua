...
Top hotspots (source:line -> count, pct of analysable)
   count       pct  location
     148    33.64%  @test_getstr.lua:36     -- update_kill: player.role.battle.stat.kill = ...
     108    24.55%  @test_getstr.lua:24     -- calc_damage: player.role.battle.weapon.damage = ...
      58    13.18%  @test_getstr.lua:49     -- update_pos: player.role.pos.y = ...
      51    11.59%  @test_getstr.lua:48     -- update_pos: player.role.pos.x = ...
      32     7.27%  @test_getstr.lua:30     -- calc_ammo: player.role.battle.weapon.ammo = ...
      17     3.86%  @test_getstr.lua:42     -- update_death: player.role.battle.stat.death = ...
      ...
```
